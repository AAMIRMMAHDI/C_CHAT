...
urlpatterns = [
    ...
    path('api/groups/<int:pk>/admins/', views.GroupAdminsView.as_view(), name='group_admins'),
    path('api/groups/<int:pk>/settings/', views.GroupSettingsView.as_view(), name='group_settings'),
    path('api/groups/<int:pk>/requests/', views.GroupJoinRequestView.as_view(), name='group_join_requests'),
